...
export function MultiplayerLobby({
  ...
  const opponentLogin = (roomInfo?.player1Login === session?.login ? roomInfo?.player2Login : roomInfo?.player1Login) || 'Игрок 2'
      ...
      <div className='bg-[#393939] rounded-2xl p-8 w-full shadow-xl flex flex-col gap-6 items-center'>
        ...
        <div className='w-full flex flex-col gap-4'>
          <div className='flex justify-between items-center p-4 rounded-lg bg-white/5'>
            ...
            <span className={isReady ? 'text-green-400 font-medium' : 'text-yellow-400 font-medium'}>
          ...
          <div className='flex justify-between items-center p-4 rounded-lg bg-white/5'>
            ...
            {opponentJoined ? (
              <span className={readyCount > (isReady ? 1 : 0) ? 'text-green-400 font-medium' : 'text-yellow-400 font-medium'}>
